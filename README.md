...
1. **📥 Установка приложения**:
   - Скачайте свежий подписанный APK из раздела [Releases](https://github.com/github-lover-9999/LunaaAdaptiveAod/releases/latest) (или напрямую [`LunaaAdaptiveAod-v1.6.5-signed.apk`](https://github.com/github-lover-9999/LunaaAdaptiveAod/releases/download/v1.6.5/LunaaAdaptiveAod-v1.6.5-signed.apk)).
